...
var dragSettings = {
						...
						answerAnimateTween:.4, //answer aniamtion tween speed
...
var shareTitle = 'Highscore on ShineZone is [SCORE]';
var shareMessage = '[SCORE] is my new highscore on ShineZone! Try it now!'; 
*/
...
function buildQuestion(){
	...
	// if answer correct load next question
...
// setting up drag event draggable/dragging toggle
...
// animation i.e draggable letters
...
// display game status i.e. amount of correct answers
...
// load question XML file containing game questions
...
function loadQuestionAssets(){
	...
	imageLoader.loadgameAssets(fileFest);
}
...
// resize game to accomodate portait / landscape screen resolution
...
// resize game fonts to fit screen resolution portait / landscape
